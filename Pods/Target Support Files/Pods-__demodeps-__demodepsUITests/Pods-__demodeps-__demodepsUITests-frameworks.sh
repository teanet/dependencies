...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/VNServicesInterfaces-framework/VNServicesInterfaces.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/VNI/VNI.framework"
fi
